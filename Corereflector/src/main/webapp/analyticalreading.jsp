...
<title>Analytical Reading</title>
</head>
<body>
...
<div id="buttonalign">
	<button class="black-button" id="backbutton" type="button" onclick="window.location.href='wrapping.jsp'">ZURÜCK</button>
	<button class="black-button" id="forwardbutton" type="button" onclick="window.location.href='reflexion.jsp'">WEITER</button>
</div>
</body>
</html>