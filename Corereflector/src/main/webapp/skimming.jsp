...
<div id="buttonalign">
	<button class="black-button" id="backbutton" type="button" onclick="window.location.href='analytischeslesen.jsp'">ZURÜCK</button>
	<button class="black-button" id="forwardbutton" type="button" onclick="window.location.href='surveying.jsp'">WEITER</button>
</div>
</body>
</html>