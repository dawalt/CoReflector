...
<div id="centerdiv">
<h1>Wrapping</h1>
<p>Nun wird das Skimming anhand eines Videos demonstriert. Darunter siehst du deine vorherigen Antworten und hast die möglichkeit, eine neue Antwort zu formulieren.</p>
...
</div><div id="buttonalign">
	<button class="black-button" id="backbutton" type="button" onclick="window.location.href='surveying.jsp'">ZURÜCK</button>
	<button class="black-button" id="forwardbutton" type="button" onclick="window.location.href='analyticalreading.jsp'">WEITER</button>
</div>
</body>
</html>